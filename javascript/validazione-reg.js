document.addEventListener('DOMContentLoaded', () => {
    ...
    // Eseguiamo il codice SOLO se siamo nella pagina di registrazione
    if (form) {
        ...
        // IL PEZZO MANCANTE: Applica i controlli a ogni input in tempo reale
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (!formValido) {
                ...
                // AGGIUNTA: Se il form è valido, blocca il tasto per evitare doppi click!
